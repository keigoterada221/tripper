...
[
  [ '寺田圭吾', '09011111111', 'a@a1', 'aaaaaa'],
  [ 'ゴー！', '09022222222', 'b@b1', 'bbbbbb'],
  [ 'マイキー', '09033333333', 'c@c1', 'cccccc'],
  [ '日向翔陽', '09044444444', 'd@d1', 'dddddd'],
  [ '青井葦人', '09055555555', 'e@e1', 'eeeeee'],
  [ '飛信隊の信', '09066666666', 'f@f1', 'ffffff'],
  [ '土方歳三', '09077777777', 'g@g1', 'gggggg'],
  [ '井上尚弥', '09088888888', 'h@h1', 'hhhhhh'],
  [ '那須川天心', '09099999999', 'i@i1', 'iiiiii'],
  [ '錦織圭', '09010101010', 'j@j1', 'jjjjjj']
].each do |a, b, c, d|
  User.create!(
    [
      {
